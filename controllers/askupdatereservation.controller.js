...
const askupdatereservation = db.AskUpdateReservation;

exports.getAskUpdateResa = function (req, res) {
  askupdatereservation
    .findAll({
      include: [
        {
          model: reservation,
...
exports.createAskApdateResa = async function (req, res) {
  askupdatereservation
    .create(req.body)
    .then((reserv) => {
      console.log(reserv);
...
exports.getAskUpdateResaByReservationId = function (req, res) {
...
exports.updateAskUpdateResa = async function (req, res) {
  ...
  try {
    ...
    const reserv = await askupdatereservation.findOne({
